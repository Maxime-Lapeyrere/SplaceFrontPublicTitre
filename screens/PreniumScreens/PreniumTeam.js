...
export  function PreniumTeam({navigation,route}) { 
    ...
    return(
        ...
        <View style={styles.header}>
            <Text style={styles.headerText}> {t('upgrade your team').toUpperCase()} </Text>
        </View>
        
        <Swiper style={styles.wrapper} dotStyle={{width: 60,height:4 }} activeDotStyle={{width: 60,height:4}} >
            <View style={styles.slide}>
                <Image source={require('../../assets/misc/splaceIcon.png')}  style={styles.icon}/>
                <Text style={styles.swipertext}> {t('unlimited number of people')} </Text>
            </View>
            <View style={styles.slide}>
                <Image source={require('../../assets/misc/splaceIcon.png')}  style={styles.icon}/>
                <Text style={styles.swipertext}>{t('multiple chats and fields to create multiple teams or topics within your team')} </Text>

            </View>
            <View style={styles.slide}>
                <Image source={require('../../assets/misc/splaceIcon.png')}  style={styles.icon}/>
                <Text style={styles.swipertext}>{t('possibility to customize the team with your logo and colors')}</Text>
            </View>
        </Swiper>
        ...
        <View style={styles.buttons} >
            <TouchableOpacity onPress={()=> {setselectButton(['orange',0]); setselectedOffer('monthly')}} style={{...styles.button,borderColor: selectButton[0]}} >
                ...
                <Text style={{...styles.buttonText,color: '#FFAF3E'}} >5,99€</Text>
            ...
            <TouchableOpacity onPress={()=> {setselectButton([0,'orange']); setselectedOffer('yearly')}} style={{...styles.button,borderColor: selectButton[1]}} >
                ...
                <Text style={{...styles.buttonText,color: '#FFAF3E'}} >57,49€</Text>
                <Text style={styles.buttonText} >5.99€/{t('month')}</Text>
        ...
        <Button title={t('no thank you')}  buttonStyle={{...styles.continue, backgroundColor: 'white',}} titleStyle={{color: '#543EFF'}} onPress={() => navigation.goBack()}/>
